...
export default class StackRanked extends React.Component {
  static propTypes = {
  ...
  deleteQuestion = () => {
    this.props.deleted(this.props.guid, this.props.id, qatypes.ranked);
  }

  moveQuestionDown = () => {
    const question = new Question(qatypes.ranked, this.props);
  ...
  questionHelperValueUpdate = (event) => {
    let updatedQuestion = new Question(qatypes.ranked, this.props);
  ...
  render() {
    ...
    return <li key={this.props.guid}>
      ...
      <div className={Style.formSection}>
        <QuestionHeader name="stack ranking" description="for ordering a list of options" id={this.props.id} deleteFunc={this.deleteQuestion} />
        
        <label className={Style.formInput}>
          <span>question <Required /></span>
          <input type="text" value={this.props.question} placeholder="(Order these options by preference?)" onChange={this.questionValueUpdate} disabled={this.props.lock} />
        </label>

        <label className={Style.formInput}>
          <span>helper text</span>
          <input type="text" value={this.props.helper} placeholder="(Those most prefered go on top)" onChange={this.questionHelperValueUpdate} disabled={this.props.lock} />
        </label>
